...
class ApartmentController extends Controller
{
    ...
    public function getAllBySection(Request $request){
        try{
            ...
            return $this->responseContext('success','Get all apartment by section', Apartment::where('userId',$this->guard()->id())->whereIn('id',$array_id)->get(),200);
        }catch (Exception $ex){
            return $this->responseContext('failure',$ex->getMessage(),[],$ex->getCode());
        }
    }
    ...
    public function getTotalCount(){
        try{
            return $this->responseContext('success','Get total count apartment', Apartment::where('userId',$this->guard()->id())->count(),200);
        }catch (Exception $ex){
            return $this->responseContext('failure',$ex->getMessage(),[],$ex->getCode());
        }
    }
